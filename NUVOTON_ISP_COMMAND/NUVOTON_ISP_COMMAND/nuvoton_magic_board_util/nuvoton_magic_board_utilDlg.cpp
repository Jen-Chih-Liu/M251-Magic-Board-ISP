...
BEGIN_MESSAGE_MAP(CnuvotonmagicboardutilDlg, CDialogEx)
	...
	//ON_BN_CLICKED(IDC_BUTTON18, &CnuvotonmagicboardutilDlg::OnBnClickedButton18)
END_MESSAGE_MAP()
...
void CnuvotonmagicboardutilDlg::OnBnClickedButton18()
{
	FILE *file = fopen("pixelart/monster_7.bmp", "rb");
	if (file == NULL) {
		TRACE("Error opening file");
		AfxMessageBox(_T("Load 8x8 bmp file false"));
		return;
